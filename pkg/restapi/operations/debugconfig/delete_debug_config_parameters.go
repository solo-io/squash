...
// DeleteDebugConfigParams contains all the bound params for the delete debug config operation
...
func (o *DeleteDebugConfigParams) bindDebugConfigID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
