...
func (o *DeleteDebugConfigURL) Build() (*url.URL, error) {
	...
	if debugConfigID != "" {
		...
		return nil, errors.New("DebugConfigID is required on DeleteDebugConfigURL")
	}
...
func (o *DeleteDebugConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDebugConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDebugConfigURL")
	}
