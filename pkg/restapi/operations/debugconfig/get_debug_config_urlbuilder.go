...
func (o *GetDebugConfigURL) Build() (*url.URL, error) {
	...
	if debugConfigID != "" {
		...
		return nil, errors.New("DebugConfigID is required on GetDebugConfigURL")
	}
...
func (o *GetDebugConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDebugConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDebugConfigURL")
	}
