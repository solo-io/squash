...
func (o *PopDebugSessionURL) Build() (*url.URL, error) {
	...
	if debugConfigID != "" {
		...
		return nil, errors.New("DebugConfigID is required on PopDebugSessionURL")
	}
...
func (o *PopDebugSessionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PopDebugSessionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PopDebugSessionURL")
	}
