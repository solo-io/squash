...
func (o *DeleteDebugAttachmentURL) WithBasePath(bp string) *DeleteDebugAttachmentURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteDebugAttachmentURL) Build() (*url.URL, error) {
	...
	if debugAttachmentID != "" {
		...
		return nil, errors.New("DebugAttachmentID is required on DeleteDebugAttachmentURL")
	}
...
func (o *DeleteDebugAttachmentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDebugAttachmentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDebugAttachmentURL")
	}
