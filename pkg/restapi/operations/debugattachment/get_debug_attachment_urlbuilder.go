...
func (o *GetDebugAttachmentURL) Build() (*url.URL, error) {
	...
	if debugAttachmentID != "" {
		...
		return nil, errors.New("DebugAttachmentID is required on GetDebugAttachmentURL")
	}
...
func (o *GetDebugAttachmentURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDebugAttachmentURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDebugAttachmentURL")
	}
