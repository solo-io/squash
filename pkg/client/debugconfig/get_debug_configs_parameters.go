...
// NewGetDebugConfigsParams creates a new GetDebugConfigsParams object
// with the default values initialized.
func NewGetDebugConfigsParams() *GetDebugConfigsParams {

	return &GetDebugConfigsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetDebugConfigsParamsWithTimeout creates a new GetDebugConfigsParams object
...
// NewGetDebugConfigsParamsWithContext creates a new GetDebugConfigsParams object
...
// NewGetDebugConfigsParamsWithHTTPClient creates a new GetDebugConfigsParams object
...
/*GetDebugConfigsParams contains all the parameters to send to the API endpoint
for the get debug configs operation typically these are written to a http.Request
*/
...
func (o *GetDebugConfigsParams) WithContext(ctx context.Context) *GetDebugConfigsParams {
	o.SetContext(ctx)
	return o
}
