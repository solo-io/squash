...
func TestSquashsoloio(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Squashsoloio Suite")
}
...
var (
	...
	_ = SynchronizedAfterSuite(func() {}, func() {
		...
		Expect(err).NotTo(HaveOccurred())
		err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete("debugattachments.squash.solo.io", &metav1.DeleteOptions{})
